...
class ModelParser():
    def __init__(self):
        ...
        self.readout: 'str' = 'mean'  # the graphs pooling method
        ...
        self.num_prototypes_per_class = 6  # the num_prototypes_per_class
        self.gat_dropout = 0.6  # dropout in gat layer
...
class MCTSParser(DataParser, ModelParser):
    rollout: int = 2  # the rollout number
    ...
    min_atoms: int = 30  # for the synthetic dataset, change the minimal atoms to 5.
    max_atoms: int = 50
    expand_atoms: int = 5  # # of atoms to expand children
